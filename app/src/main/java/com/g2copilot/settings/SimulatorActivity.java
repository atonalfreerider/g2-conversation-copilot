...
public final class SimulatorActivity extends Activity {
    ...
    private TextView contextLine, branchOne, branchTwo, axisHint, liveLog; private EditText utterance; private Button microphone; private Spinner speechLanguage, backend;
