...
final class PromptBuilder {
    static String build(String language,boolean playful,boolean inquisitive,int risk,String biography,String transcript){
        ...
        return "CONTROL VARIABLES: language="+language+"; persona="+(playful?"P":"S")+"; stance="+(inquisitive?"I":"D")+"; risk="+risk+"/7.\n"+
            ...
            "Infer the active language only when language=AUTO. Return only JSON: {\"language\":\"two-letter code\",\"context\":\"...\",\"branches\":[{\"english\":\"...\",\"phonetic\":\"...\"},{\"english\":\"...\",\"phonetic\":\"...\"}]}. context must contain ONLY a clean English translation of the last 20 microphone words—no 'user said', 'they said', speaker label, language label, explanation, or commentary. Generate exactly two short, organic next things the biography's speaker could say, grounded in the whole conversation and their point of view. P=playful; S=strategic/trust-building; I=questions; D=statements. For English speech, english is the suggested sentence and phonetic is empty. For non-English speech, english is the clean English meaning and phonetic is ONLY the same reply rendered as stupidly easy English sound spelling: familiar English syllables, spaces, and simple hyphens; no native spelling, diacritics, IPA, labels, or commentary. Mandatory example: Polish Dzień dobry → Teen Doe Bray. Each field must be complete and at most 60 characters.";
    }
